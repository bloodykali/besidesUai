...
parser = argparse.ArgumentParser(description='Falling Pickaxe Game')
parser.add_argument('-l', '--livestream', help='YouTube Livestream ID')
...
if config["CHAT_CONTROL"] == True:
    ...
    livestream_id = args.livestream if args.livestream else config["LIVESTREAM_ID"]
    if livestream_id is not None and livestream_id != "":
        stream_id = validate_live_stream_id(livestream_id)
